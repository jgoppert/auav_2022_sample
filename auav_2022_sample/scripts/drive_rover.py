...
if __name__ == '__main__':
  ...
  try:
    ...
    print('going right')
    resp1 = apply_joint_effort('rover::right_rear_wheel_hinge', -0.1,
            rospy.Duration.from_sec(0),
            rospy.Duration.from_sec(-1))
    print(resp1)
    resp1 = apply_joint_effort('rover::left_rear_wheel_hinge', -0.1,
            rospy.Duration.from_sec(0),
            rospy.Duration.from_sec(-1))
    print(resp1)
    resp1 = apply_joint_effort('rover::left_front_steer_hinge', -0.1,
            rospy.Duration.from_sec(0),
            rospy.Duration.from_sec(-1))
    print(resp1)
    resp1 = apply_joint_effort('rover::right_front_steer_hinge', -0.1,
            rospy.Duration.from_sec(0),
            rospy.Duration.from_sec(-1))
    print(resp1)
    time.sleep(3)
